...
$user= new User($faker->unique()->randomNumber, $faker->userName, $name);
echo "<b>Пользователь:</b> " . "<br>" . $user . "<br>";

$article = new Article($faker->unique()->randomNumber, $user->getId(), $faker->sentence, $faker->text());
echo "<b>Статья</b> : " . "<br>" . $article . "<br>";

$comment = new Comment($faker->unique()->randomNumber, $user->getId(), $article->getId(), $faker->text());
